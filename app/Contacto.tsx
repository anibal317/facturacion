...
export default function Contacto() {
  ...
  return (
    <>
      <div className="bg-[#FFFFFF] w-screen h-auto rounded-[25px] flex flex-col justify-center items-center">
        <h2 className="p-2">Hora de atención por consultas de 13hs a 17hs</h2>
        <div className="bg-[#FFFFFF] w-[50%] h-[40%] rounded-[25px] pb-2">
          <div className="flex flex-col-reverse lg:flex-row">
            <div>
            </div>
            <div id="dialogo" className="bg-[#EFEFEF] p-6 lg:w-1/2 rounded-[15px] lg:rounded-[25px] mt-2 lg:mt-0 lg:mr-2">
              {!isSend ? <>
            ...
            <div id="imgDeJovenes" className={`rounded-[15px] lg:rounded-[25px] h-28 lg:h-auto mb-2 lg:mb-0 lg:ml-2 w-full lg:w-1/2 bg-cover bg-center ${isSend ? "bg-[url('/imgs/contacto/contacto_ok.webp')]" : "bg-[url('/imgs/contacto/contacto.webp')]"}`}>
